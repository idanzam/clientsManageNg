...
export class ShortNumberPipe implements PipeTransform {
  ...
  transform(number: number, args?: any,digitsAfterDecimal: number = 3): any {
    if (isNaN(number)) 
    ...
    const formattedNumber = abs.toFixed(digitsAfterDecimal);
